...
class Mobileimage extends AbstractRenderer
{
   ...
   public function render(\Magento\Framework\DataObject $row){
       ...
       $html = '<a  style="display: inline-block;text-align: center;width: 100%;" id="popup-modal-2" href="javascript:void(0);" data-href="'.$imageUrl.'" ><img src="'.$imageUrl.'" width="250"/></a>';
       $html .= "
       <script>
          require([
                  'jquery',
              ...
              function(
                  ...
                  $('#popup-modal-2').on('click',function(){ 
                      var imgTag = $(\"<img id='popup-img-2' style='text-align: center;margin: 0 auto;display: block;' src='\"+$(this).attr(`data-href`)+\"' /> \");
